...
describe('Classic, Minimal and Executive print the header gaps (header_spacing_spec.md)', () => {
  ...
  // Guard: the letterhead follows the résumé's gaps it prints (header_spacing_spec.md D5): Name ↔
  // Title, Photo ↔ Text, Title ↔ Contacts, Icon ↔ Text and Between contacts (and rows) — 45- to
