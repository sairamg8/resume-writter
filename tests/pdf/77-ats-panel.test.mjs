...
//   - the job-description scanner's "+", which wrote into a hidden skill group (R2-024);
//   - "Put Job Title First", which rewrote hidden sections the report never inspected (R2-079);
//   - Copy Text and the .txt download, and Copy failing silently where the clipboard is refused (R2-080).
//
...
/** Lets a promise the panel started settle, and React commit what it set. */
const settle = async () => {
