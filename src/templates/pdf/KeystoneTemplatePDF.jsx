 ...
 * width from the name's row, and in a centred header stands centred over the name. ATS: certified — the wedge is a shape, not text.
 */
export function KeystoneTemplatePDF({ data }) {
  ...
  return <PdfDesignedDocument data={data} header={<PdfDesignedHeader personal={data.personal} settings={s} beside={{ node: wedge, width, gap: KEYSTONE_WEDGE.gap }} />} />;
}
