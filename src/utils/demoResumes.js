...
export const DEMO_RESUMES = [
  ...
  sample('demo_modern', 'Sample · Modern', 'modern',
    { accentColor: '#1d4ed8', textColor: '#1a1a1a', headingStyle: 'line', sectionTitleCase: 'upper', fontSizeNameDelta: 10, sectionGap: 14, itemGap: 10 }),
  sample('demo_minimal', 'Sample · Minimal', 'minimal',
    { accentColor: '#374151', textColor: '#111827', headingStyle: 'underline', sectionTitleCase: 'upper', sectionGap: 18, itemGap: 10, marginH: 20, marginV: 16 }),
  sample('demo_sidebar', 'Sample · Sidebar', 'sidebar',
    { accentColor: '#1e40af', textColor: '#1a1a1a', headingStyle: 'plain', sectionTitleCase: 'upper', sidebarBg: '#1e40af', headerTextColor: '#ffffff', nameColor: '#ffffff', jobTitleColor: '#bfdbfe', sectionGap: 14, itemGap: 10 }),
  sample('demo_executive', 'Sample · Executive', 'executive',
    { accentColor: '#2563eb', textColor: '#111111', headingStyle: 'underline', sectionTitleCase: 'normal', fontSizeNameDelta: 9, sectionGap: 16, itemGap: 10 }),
];
