// Custom brand icon SVGs sized to match Lucide's style (strokeWidth, size prop)

export function LinkedinIcon({ size = 16, strokeWidth = 2, className = '', style }) {
  return (
    <svg
...
export function GithubIcon({ size = 16, strokeWidth = 2, className = '', style }) {
  return (
    <svg
      width={size} height={size} viewBox="0 0 24 24"
      fill="none" stroke="currentColor" strokeWidth={strokeWidth}
