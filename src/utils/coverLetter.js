 ...
 * once the user has typed them, else the résumé's name and title: a field typed and deleted again
 * ('') shows the same empty box and résumé-name placeholder as one never touched, so it prints the
...
export function letterSignature(cl = {}, personal = {}) {
  ...
  return {
    ...
    designation: text(cl.signatureDesignation) || personal?.title || '',
