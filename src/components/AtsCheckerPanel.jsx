...
export default function AtsCheckerPanel({ resume, store }) {
  ...
  return (
    <div className="space-y-5 text-gray-800 pb-12">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="text-base font-bold text-gray-900 leading-tight">ATS Score & Parser Checker</h2>
                <p className="text-xs text-gray-500 mt-0.5">Tested for Workday, Taleo, Greenhouse, Lever & iCIMS</p>
              </div>
            </div>
          </div>

          {/* Big Score Badge */}
          <div className={`flex flex-col items-center justify-center px-4 py-2.5 rounded-2xl border ${scoreColor} shrink-0`}>
            <div className="text-2xl font-black tracking-tight leading-none">{totalScore}<span className="text-xs font-semibold text-gray-500">/100</span></div>
            <div className="text-[11px] font-bold uppercase mt-1 tracking-wider">{grade} · {gradeLabel}</div>
          </div>
        </div>
      ...
      <div className="p-4 bg-gradient-to-br from-gray-50 to-blue-50/40 border border-gray-200 rounded-2xl flex items-center justify-between gap-3">
      ...
      <div className="p-5 bg-white border border-gray-200 rounded-2xl shadow-sm space-y-3">
        <div className="flex items-center justify-between">
          ...
          {jobMatch && (
            <div className="text-xs font-bold px-2.5 py-1 rounded-full bg-purple-100 text-purple-700 border border-purple-200">
