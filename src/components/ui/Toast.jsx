    ...
    >
      ...
      {action && (
        <button
          ...
          className={cx('shrink-0 rounded-md px-2 py-1 text-[13px] font-semibold text-indigo-600 transition-colors hover:bg-indigo-50 hover:text-indigo-700', FOCUS_RING)}
        >
          {action.label}
        </button>
      )}
