 ...
 * edited copy from this browser or the cloud. An account with no original has nothing to bring
 * back — except on the dev server, where the owner's own résumé from the private file becomes it
 * (privateOriginal) and syncs to their account from there. The rules and their order live in
 * utils/demoRestore.js, which the sync tests run; this hook only calls it after each render.
 */
