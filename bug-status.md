...
> `origin/master` (deployed) = `207e9a4` · **nothing is waiting to be pushed**
> **Open: 12** | Fixed, not pushed: 0 | **Closed: 69**

## Summary

| List | Found | ✅ Fixed and pushed | ⏸ Fixed, local only | 🔴 Open |
|---|---|---|---|---|
| Bug audit, 2026-09-22 (`AUD-`) | 35 (34 + one follow-up) | 30 | 0 | **5** |
...
1. The Low rows left: AUD-29 … AUD-33.
2. ATS-1 … ATS-6 — no order set yet; ATS-6 waits on a decision.
3. TUI-3, TUI-4, TUI-6 — TUI-6 to be filed as ATS-7.

✅ **All fixes are pushed.** `origin/master` = `207e9a4` (AUD-28). Gate on that exact tree, 2026-09-23 15:49:
**1642 tests, 1640 pass, 0 fail, 2 todo** (the two known ATS `todo`s), a green production build, and a
