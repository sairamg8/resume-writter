...
> Updated: 2026-09-22 21:41 · `origin/master` (deployed) = `2a7d728` · fixed but not pushed: `fd7ecca`, `4ee5ede`, `f829ce3`, `e2dffbf`
> **Open: 25** | Fixed, not pushed: 5 | **Closed: 44**

## Summary

| List | Found | ✅ Fixed and pushed | ⏸ Fixed, local only | 🔴 Open |
|---|---|---|---|---|
| Bug audit, 2026-09-22 (`AUD-`) | 35 (34 + one follow-up) | 11 | 5 | **19** |
...
1. **AUD-13** — Markdown export: Skills, Languages, Volunteering and dates.
2. AUD-14 + AUD-15 → AUD-17 → AUD-19 → AUD-21 → AUD-22 → AUD-23 → AUD-24 → the Low rows,
   AUD-25 … AUD-34.
3. ATS-1 … ATS-6 — no order set yet; ATS-6 waits on a decision.

⏸ **Not pushed yet:** AUD-09 (`fd7ecca`), AUD-16 (`4ee5ede`), AUD-10 and AUD-11 (`f829ce3`), AUD-12 (`e2dffbf`) wait for the owner's go. The push gate runs every test,
