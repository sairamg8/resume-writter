...
> `origin/master` (deployed) = `1eaaee6` · **nothing is waiting to be pushed**
> **Open: 13** | Fixed, not pushed: 0 | **Closed: 68**

## Summary

| List | Found | ✅ Fixed and pushed | ⏸ Fixed, local only | 🔴 Open |
|---|---|---|---|---|
| Bug audit, 2026-09-22 (`AUD-`) | 35 (34 + one follow-up) | 29 | 0 | **6** |
...
1. The Low rows left: AUD-28 … AUD-33.
2. ATS-1 … ATS-6 — no order set yet; ATS-6 waits on a decision.
3. TUI-3, TUI-4, TUI-6 — TUI-6 to be filed as ATS-7.

✅ **All fixes are pushed.** `origin/master` = `1eaaee6` (AUD-27). Gate on that exact tree, 2026-09-23 15:40:
