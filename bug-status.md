...
> `origin/master` (deployed) = `e82bd31` · **AUD-28 is fixed and waiting to be pushed**
> **Open: 12** | Fixed, not pushed: 1 | **Closed: 68**

## Summary

| List | Found | ✅ Fixed and pushed | ⏸ Fixed, local only | 🔴 Open |
|---|---|---|---|---|
| Bug audit, 2026-09-22 (`AUD-`) | 35 (34 + one follow-up) | 29 | 1 | **5** |
...
1. The Low rows left: AUD-29 … AUD-33 (AUD-28 is ⏸, local).
2. ATS-1 … ATS-6 — no order set yet; ATS-6 waits on a decision.
3. TUI-3, TUI-4, TUI-6 — TUI-6 to be filed as ATS-7.

✅ **Every fix but AUD-28 (⏸, local) is pushed.** Gate on the exact tree of `1eaaee6` (AUD-27), 2026-09-23 15:40:
**1634 tests, 1632 pass, 0 fail, 2 todo** (the two known ATS `todo`s), a green production build, and a
