...
| File | What | Rows |
|---|---|---|
| [01-high-medium.md](01-high-medium.md) | defects, High then Medium | 75 (R3 rows: found by the build lanes, 2026-09-24) |
| [02-low.md](02-low.md) | defects, Low | 66 (R3 rows: found by the build lanes, 2026-09-24) |
